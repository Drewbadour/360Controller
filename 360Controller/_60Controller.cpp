...
//        typedef struct {
//            // Init packets will only apply to devices covered under the target vendor/prodct combo.
//            // 0 will apply to all products/vendors.
//            UInt32 targetVendorId;
//            UInt32 targetProductId;
//            UInt8[] data;
//        } XoneInitData;

        UInt8 xoneHoriInit[] = { 0x01, 0x20, 0x00, 0x09, 0x00, 0x04, 0x20, 0x3a, 0x00, 0x00, 0x00, 0x80, 0x00 };
        UInt8 xoneFw2015Init[] = { 0x05, 0x20, 0x01, 0x01, 0x00 };
        UInt8 xonePdpInit1[] = { 0x0a, 0x20, 0x02, 0x03, 0x00, 0x01, 0x14 };
